...
/**
 * 「対象のエンティティはすでに存在している」場合に使用するException
 * @author xytamura
 */
public class AlreadyExistException extends ApplicationException {

    private static final String WRN_MSG_ID = "W0101";

    private static final String ERR_MSG_ID = "E0101";

    /**
     * コンストラクタ
     * @param entity メッセージのパラメータ
     */
    public AlreadyExistException(final String entity) {
        this(entity, "", false);
    }
     ...
     * @param detail 詳細情報
     */
    public AlreadyExistException(final String entity, final String detail) {
