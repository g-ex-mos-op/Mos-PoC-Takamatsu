...
public class MismatchException extends ApplicationException {
    ...
    private static final String WRN_MSG_ID = "W0604";

    private static final String ERR_MSG_ID = "E0604";

    /**
     * コンストラクタ
     * @param entity メッセージのパラメータ
     */
    public MismatchException(final String entity) {
        this(entity, "", false);
    }
     ...
     * @param detail 詳細情報
     */
    public MismatchException(final String entity, final String detail) {
