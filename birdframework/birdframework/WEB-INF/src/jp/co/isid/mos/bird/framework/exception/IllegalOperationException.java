...
public class IllegalOperationException extends ApplicationException {
    ...
    private static final String WRN_MSG_ID = "W0406";

    private static final String ERR_MSG_ID = "E0406";
     ...
     */
    public IllegalOperationException(final String entity1, final String entity2) {
     ...
     * @param detail 詳細情報
     */
    public IllegalOperationException(final String entity1,
     ...
     */
    public IllegalOperationException(final String entity1,
            final String entity2, final String detail, boolean warningFlg) {
