...
/**
 * 「処理対象が存在しない」場合に使用するException
 * @author xytamura
 *
 */
public class NoTargetException extends ApplicationException {

    private static final String WRN_MSG_ID="W0203";
    private static final String ERR_MSG_ID="E0203";
    
    /**
     * コンストラクタ 
     * @param entity メッセージのパラメータ
     */
    public NoTargetException(final String entity){
        this(entity, "", false);
    }
     ...
     * @param detail 詳細情報
     */
    public NoTargetException(final String entity, final String detail){
     ...
     */    
    public NoTargetException(final String entity, final String detail, boolean warningFlg){
