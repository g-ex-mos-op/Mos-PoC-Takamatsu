...
/**
 * 「ある理由で操作を行う事ができない」場合に使用するException
 * @author xytamura
 */
public class CannotExecuteWithReasonException extends ApplicationException {

    private static final String ERR_MSG_ID = "E0404";
     ...
     */
    public CannotExecuteWithReasonException(final String entity1,
     ...
     */
    public CannotExecuteWithReasonException(
