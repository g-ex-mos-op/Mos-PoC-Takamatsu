...
/**
 * 「ユーザ同士で処理の競合」場合に使用するException
 * @author xytamura
 */
public class SomeoneExecutingException extends ApplicationException {

    private static final String ERR_MSG_ID = "E0414";
     ...
     */
    public SomeoneExecutingException(final String entity1, final String entity2) {
     ...
     * @param detail 詳細情報
     */
    public SomeoneExecutingException(final String entity1,
            final String entity2, final String detail) {
     ...
     */
    public SomeoneExecutingException(final String entity1,
            final String entity2, final String errHtmlElementName,
     ...
     */
    public SomeoneExecutingException(
