 ...
 * @author xytamura
 */
public class NotRelevantException extends ApplicationException {

    private static final String WRN_MSG_ID = "W0606";

    private static final String ERR_MSG_ID = "E0606";
     ...
     */
    public NotRelevantException(final String entity1, final String entity2) {
