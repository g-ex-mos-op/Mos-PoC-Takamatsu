...
/**
 * 「必須入力項目が入力されていない」場合に使用するException
 * @author xytamura
 */
public class NotNullException extends ApplicationException {

    private static final String WRN_MSG_ID = "W0506";

    private static final String ERR_MSG_ID = "E0506";

    /**
     * コンストラクタ
     * @param entity メッセージのパラメータ
     */
    public NotNullException(final String entity) {
        this(entity, "", false);
    }
     ...
     * @param detail 詳細情報
     */
    public NotNullException(final String entity, final String detail) {
