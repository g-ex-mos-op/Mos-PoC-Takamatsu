 ...
 * @author xytamura
 */
public class CannotChangeException extends ApplicationException {

    private static final String WRN_MSG_ID = "W0501";

    private static final String ERR_MSG_ID = "E0501";

    /**
     * コンストラクタ
     * @param entity メッセージのパラメータ
     */
    public CannotChangeException(final String entity) {
        this(entity, "", false);
    }
     ...
     * @param detail 詳細情報
     */
    public CannotChangeException(final String entity, final String detail) {
