 ...
 *
 */
public class NoInputException extends ApplicationException {

    private static final String WRN_MSG_ID="W0507";
    private static final String ERR_MSG_ID="E0507";
    
    /**
     * コンストラクタ 
     * @param entity メッセージのパラメータ
     */
    public NoInputException(final String entity){
        this(entity, "", false);
    }
     ...
     * @param detail 詳細情報
     */
    public NoInputException(final String entity, final String detail){
     ...
     */    
    public NoInputException(final String entity, final String detail, boolean warningFlg){
