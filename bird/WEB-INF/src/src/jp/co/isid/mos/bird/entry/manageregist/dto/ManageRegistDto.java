package jp.co.isid.mos.bird.entry.manageregist.dto;
 ...
 * @author xjung
 */
public class ManageRegistDto extends CommonDto {
    /** セッション関連情報管理クラス */
    ...
    /**
     * 全国店長勉強会マスタ情報リストを設定する
     * @param mstInfoList 全国店長勉強会マスタ情報リスト 
     */
    ...
    public String getTargetProcess() {
        if(ManageRegistConstants.EDIT_MODE_INSERT == getEditMode()){
            return ManageRegistConstants.PROCESS_INSERT;
        }
        else if(ManageRegistConstants.EDIT_MODE_UPDATE == getEditMode()){
            return ManageRegistConstants.PROCESS_UPDATE;
        }
        else if(ManageRegistConstants.EDIT_MODE_DELETE == getEditMode()){
            return ManageRegistConstants.PROCESS_DELETE;
        }
        return ManageRegistConstants.EMPTY;
    }
    ...
    public boolean isReadOnly() {
        ...
        return (ManageRegistConstants.EDIT_MODE_UPDATE == getEditMode()
                && getSysDate() != null
    ...
    public void clear() {
        ...
        setEntryKbnList(initSelectionList(ManageRegistConstants.SEL_KBN_ENTRY));
        setOptionalList(initSelectionList(ManageRegistConstants.SEL_KBN_OPTIONAL));
    }
