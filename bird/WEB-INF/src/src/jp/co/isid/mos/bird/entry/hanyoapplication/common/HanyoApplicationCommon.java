package jp.co.isid.mos.bird.entry.hanyoapplication.common;
 ...
 *
 */
public class HanyoApplicationCommon {
    
    /* VIEW_ID */
    public static final String VIEW_ID            = "BEN005";
    public static final String VIEW_ID_SELECT     = "BEN005V01";
    public static final String VIEW_ID_EDIT       = "BEN005V02";
    public static final String VIEW_ID_CONFIRM    = "BEN005V03";
    // 店検索
    ...
    /* エントリーコード */
    public static final String ENTRYCD_SHUTTYO = "05";
    public static final String ENTRYCD_KOUSIN  = "30";
    ...
    public static final int NUMBER_CHECK_MODE_REGIST = 3;
    ...
    public static final String ENTRY_NAME_SHUTTYO = "出張研修";
    public static final String ENTRY_NAME_KOUSIN = "更新研修";
