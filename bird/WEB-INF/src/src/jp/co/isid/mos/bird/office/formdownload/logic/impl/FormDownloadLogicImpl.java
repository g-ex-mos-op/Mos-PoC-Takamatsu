 ...
 * @author xytamura
 */
public class FormDownloadLogicImpl implements DownloadLogic {

    /* ロジックID */
    public static final String LOGIC_ID = "BOF002L04";
    ...
    public String getFileName(final DownloadDto downloadDto) {
        FormDownloadDto dto = (FormDownloadDto) downloadDto;
        String fileName = "";
        switch (getDownloadMode(downloadDto)) {
            case 1:
                // フォーム
                UIFormDownLoad entity = dto.getEntityViewDetail();
                fileName = entity.getFileName();
                break;
            case 2:

                int index = dto.getSelectedAttachFileIndex();
                UIFormDownLoad targetEntity = (UIFormDownLoad)dto.getListForm().get(dto.getDownloadFileIndex());
            ...
            case 3:
                int viewIndex = dto.getViewSelectAttachFileIndex();
                UIFormDownLoad viewTargetEntity = (UIFormDownLoad)dto.getListForm().get(dto.getSelectIndex());
...
//                break;
    ...
    public String getFileFullPath(final DownloadDto downloadDto) {
        String path = BirdContext.getProperty("fileProperty", "filePathForm");
        String fileName = "";
        FormDownloadDto dto = (FormDownloadDto) downloadDto;
        switch (getDownloadMode(downloadDto)) {
            case 1:
