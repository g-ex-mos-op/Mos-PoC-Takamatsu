...
import jp.co.isid.mos.bird.bizreport.groupeigyoniporef.action.GroupEigyoNipoRefMiseConfirmAction;
 ...
 */
public class GroupEigyoNipoRefMiseConfirmActionImpl extends CsvOutput2ActionImpl implements GroupEigyoNipoRefMiseConfirmAction {
    /** アクション【初期化処理】ID */
    public static final String initialize_ACTION_ID  = "BBR001A09";

    /** アクション【検索】ID */
    public static final String reSearch_ACTION_ID = "BBR001A10";

    /** CSVダウンロードアクションID */
    public static final String downloadCsv_ACTION_ID = "BBR001A11";

    /** 店舗リンクアクションID */
    public static final String selectedMise_ACTION_ID = "BBR001A12";

    /** 宅配売上日報タブリンクアクションID */
    public static final String goTakuhaiNipo_ACTION_ID = "BBR001A13";

    /** 屋号別売上タブリンクアクションID */
    public static final String goYago_ACTION_ID = "BBR001A14";

    /** 対象支部リスト取得アクションID */
    public static final String reSearchTaishoSibuList_ACTION_ID = "BBR001A15";
    /** アクション【通貨切替】ID */
    public static final String changeCurrency_ACTION_ID = "BBR001A29";
    /** アクション【MOSCARD画面遷移】ID */
    public static final String callMoscard_ACTION_ID = "BBR001A32";
    /** アクション【SV検索ボタン】ID */
    public static final String callSvForm_ACTION_ID   = "BBR001A50";
    /** アクション【ネット注文画面遷移】ID */
    public static final String callNetorder_ACTION_ID = "BBR001A52";
    ...
    public String initialize() {
        ...
        //２．SV選択画面から遷移してきた場合。2008/12/09追加 **************************/
            ...
            try {
	        	...
	        	ResultDto saveResultDto = (ResultDto)getGroupEigyoNipoRefMapResultDto().getResultDto(windowId);
	        	if(saveResultDto != null) {
	        		setGroupEigyoNipoRefResultDto(saveResultDto);
	        	}
    ...
    public String callSvForm()  {
        ...
        getNewSvSearchDto().setNavigationCase(NipoRefConstants.VIEW_ID_E_MISE);
    ...
    public String reSearchTaishoSibuList() {
        ...
        if(!getGroupEigyoNipoRefResultDto().isExistDataFlg()) {
    ...
    public String callNetorder() {
        ...
        NipoRefUtil.callScreenInitialize(
        		getNipoRefConditionDto(), searchParamDto, resultParamDto, isNewWindowFlg());
        //３．ネット注文結果画面(店舗別)VIEW_IDをリターンします。
    ...
    private void searchMiseUriageInfo(NipoRefConditionParameterDto parameterDto) {
        ...
        if(!parameterDto.isSvFlg()) {
            ...
            if (EigyoNipoCommon.isNull(parameterDto.getSibuCd())) {
                ...
                throw new NotNullException(EigyoNipoConstants.MSG_SIBU_CD, "taishoSibu", 0);
            }
        }
        //４．Try開始 検索処理を行います。
        try {
            ...
            List uriageList = (List) uriageNipoMap.get(EigyoNipoConstants.MAP_URIAGE_LIST);
            //8.Map[店別売上予算情報]の客数リストを変数List[[客数]]とします。
            List kyakusuList = (List) uriageNipoMap.get(EigyoNipoConstants.MAP_KYAKUSU_LIST);
            ...
            String svName = (String) paramMap.get(EigyoNipoConstants.SV_NAME);
	        ...
	        groupEigyoNipoRefResultDto.setSearchListType(TaishoJoken.CODE_MISE);
