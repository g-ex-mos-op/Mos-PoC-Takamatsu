...
/**
 * マトリクス認証のキー情報用Entity
 * ※ 認証キーの数を増やした場合は、getAllMatrixKey()メソッドを修正して下さい。
 * @author xnkusama
 */
public class UIUserMatrixInfo {
   ...
   /**
     ...
     * @return List
     */
    public List getAllMatrixKey() {
        List ret = new ArrayList();
        ret.add(getMatrixKey1());
        ret.add(getMatrixKey2());
        ret.add(getMatrixKey3());
        ret.add(getMatrixKey4());
        ret.add(getMatrixKey5());
        return ret;
    }
    /**
