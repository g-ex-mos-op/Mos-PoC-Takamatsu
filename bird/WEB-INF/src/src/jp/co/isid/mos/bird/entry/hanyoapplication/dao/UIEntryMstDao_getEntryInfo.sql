SELECT 
    ...
    case when STAFF.staffSu is null then 0 else staff.staffSu end as STAFFSU,
...
WHERE 
    br17.ENTRY_CD = /*entryCd*/'05'
and br17.ENTRY_YEAR = /*entryYear*/'2006'
and br17.ENTRY_KAI = /*entryKai*/'047' 