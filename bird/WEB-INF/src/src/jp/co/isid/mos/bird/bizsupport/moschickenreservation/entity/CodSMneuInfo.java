...
public class CodSMneuInfo {
    ...
    * @param checkedMenu2
    */
   public void setCheckedMenu2(boolean checkedMenu2) {
       this.checkedMenu2 = checkedMenu2;
   }    
}
