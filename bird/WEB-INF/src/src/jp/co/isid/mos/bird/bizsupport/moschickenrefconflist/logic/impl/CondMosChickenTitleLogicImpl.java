...
import jp.co.isid.mos.bird.bizsupport.moschickenrefconflist.dao.MstMosChickenFromToDao;
...
public class CondMosChickenTitleLogicImpl implements CondMosChickenTitleLogic{
    ...
    /** ロジックID 定義 */
    public static final String LOGIC_ID = "BBS020L01";
    ...
    private List titleSerch(MosChickenRefConfListCondDto dto) {
