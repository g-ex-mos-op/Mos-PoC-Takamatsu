...
public class TrnURL {
    ...
    public static final String TABLE = "BT27MURL";
    ...
    /**
     * 地図URLを取得します。
     * @return convString(地図URL
     */
    public String getUrl() {
        return convString(url);
    }
    /**
     * 地図URLを設定します。
     * @param url 地図URL
