...
,               sum(open_kbn_zen_doyo)           as open_kbn_zen
...
,               (select  bd54.company_cd
                 ...
                 ,      max(bd54.open_kbn_zen_doyo)          as open_kbn_zen_doyo
                 ,      sum(bd54.uriage_zen_doyo)            as uriage_zen_doyo
                 ,      sum(bd54.kyakusu_zen_doyo)           as kyakusu_zen_doyo
                 ,      sum(bd54.uriage_zen_doyo_nsum)       as uriage_zen_doyo_nsum
                 ,      sum(bd54.kyakusu_zen_doyo_nsum)      as kyakusu_zen_doyo_nsum
                 ,      sum(bd54.uriage_zen_doyo_ntake)      as uriage_zen_doyo_ntake
                 ,      sum(bd54.kyakusu_zen_doyo_ntake)     as kyakusu_zen_doyo_ntake
                 ,      sum(bd54.uriage_zen_doyo_ntaku)      as uriage_zen_doyo_ntaku
                 ,      sum(bd54.kyakusu_zen_doyo_ntaku)     as kyakusu_zen_doyo_ntaku
                 from    BD54NNIP as bd54
                 ,       bn01dten as bn01
                 where   bd54.eigyo_dt = bn01.eigyo_dt
