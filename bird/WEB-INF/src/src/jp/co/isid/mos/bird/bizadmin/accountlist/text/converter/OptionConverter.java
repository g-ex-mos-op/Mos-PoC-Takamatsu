 ...
 * @author xnkusama
 */
public class OptionConverter extends NormalConverter implements Converter, Formatter {
    /**
     * コンストラクタ 
     */
    ...
    public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object value)
        ...
        if (AccountListConst.OPTION_FLG_AVAILABLE.equals(val)) {
            val = AccountListConst.OPTION_FLG_AVAILABLE_DISP;
        }
        else if (AccountListConst.OPTION_FLG_NOT_AVAILABLE.equals(val)){
            val = AccountListConst.OPTION_FLG_NOT_AVAILABLE_DISP;
        }
        else if (AccountListConst.OPTION_FLG_NO_TARGET.equals(val)){
            val = AccountListConst.OPTION_FLG_NO_TARGET_DISP;
        }
        return val;
    }
