...
public class UIPoint {
    ...
    public static final String koumokuSub_COLUMN = "KOUMOKU_SUB";
     ...
     * @return 項目枝番
     */
    public String getKoumokuSub() {
        return koumokuSub;
    }
    /**
     * 項目枝番を設定します。
     * @param koumokuSub 項目枝番
     */
    public void setKoumokuSub(String koumokuSub) {
        this.koumokuSub = koumokuSub;
    }
