...
public class UIEntryNotice {
    ...
    public static final String notice2_COLUMN = "NOTICE2";
    
    public static final String notice3_COLUMN = "NOTICE3";
