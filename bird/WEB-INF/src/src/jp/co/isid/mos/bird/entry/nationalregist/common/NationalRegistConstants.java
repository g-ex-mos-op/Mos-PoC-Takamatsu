 ...
 * @author xjung
 */
public interface NationalRegistConstants {
//　画面・VIEW ID定数
    /** 画面ID:全国大会マスタ登録画面 */
	public static final String SCREEN_ID = "BEN014";
	/** VIEW_ID:全国大会マスタ登録 条件画面 */
    public static final String VIEW_ID_SELECT = "BEN014V01";
    /** VIEW_ID:全国大会マスタ登録 編集画面 */
    public static final String VIEW_ID_EDIT = "BEN014V02";
    /** VIEW_ID:全国大会マスタ登録 確認画面 */
    public static final String VIEW_ID_CONFIRM = "BEN014V03";
    /** VIEW_ID：操作エラー画面 */
...
// メッセージの定数
    ...
    /** メッセージ：全国大会マスタ登録情報 */
    public static final String MSG_NATIONAL_REGIST_INFO = "全国大会マスタ登録情報";
    /** メッセージ：全国大会マスタ情報 */
    public static final String MSG_NATIONAL_MST_INFO = "全国大会マスタ情報";
    /** メッセージ：排他エラー１ */
    ...
    /** メッセージ：年度算出ロエラー(全国大会マスタ情報リスト取得ロジック) */
    public static final String MSG_ERR_PREV_YEAR =
        "全国大会マスタ情報リスト取得時、年度算出ロジックでエラーが発生しました。";
    /** メッセージ：年度算出ロエラー(全国大会マスタ情規登録ロジック) */
    public static final String MSG_ERR_ENTRY_YEAR =
        "全国大会マスタ情規登録時、年度算出ロジックでエラーが発生しました。";
    /** メッセージ：エントリー日付情報取得失敗(全国大会マスタ情報取得ロジック) */
    public static final String MSG_ERR_DATE_INFO =
        "全国大会マスタ情報取得の時、エントリー日付情報取得に失敗しました。";
    /** メッセージ：エントリーセレクション情報取得失敗(全国大会マスタ情報取得ロジック) */
    public static final String MSG_ERR_SELECTION_INFO =
        "全国大会マスタ情報取得の時、エントリーセレクション情報(申込区分、オプショナル)取得に失敗しました。";
