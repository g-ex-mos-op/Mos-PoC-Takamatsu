...
,               (select  bd54.company_cd
                 ...
                 ,      max(bd54.open_kbn_zen_dojitu)          as open_kbn_zen_dojitu
                 ,      sum(bd54.uriage_zen_dojitu)            as uriage_zen_dojitu
                 ,      sum(bd54.kyakusu_zen_dojitu)           as kyakusu_zen_dojitu
                 ,      sum(bd54.uriage_zen_dojitu_nsum)       as uriage_zen_dojitu_nsum
                 ,      sum(bd54.kyakusu_zen_dojitu_nsum)      as kyakusu_zen_dojitu_nsum
                 ,      sum(bd54.uriage_zen_dojitu_ntake)      as uriage_zen_dojitu_ntake
                 ,      sum(bd54.kyakusu_zen_dojitu_ntake)     as kyakusu_zen_dojitu_ntake
                 ,      sum(bd54.uriage_zen_dojitu_ntaku)      as uriage_zen_dojitu_ntaku
                 ,      sum(bd54.kyakusu_zen_dojitu_ntaku)     as kyakusu_zen_dojitu_ntaku
