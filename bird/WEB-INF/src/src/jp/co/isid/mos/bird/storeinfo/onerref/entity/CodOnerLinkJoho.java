...
public class CodOnerLinkJoho implements BirdLinkJohoEntity {
    
    public static final String TABLE = "BR38OLNK";
    
    public static final String oLinkId_COLUMN = "O_LINK_ID";
     ...
     * @return オーナー照会リンクID
     */
    public String getOLinkId() {
        return oLinkId;
    }
    /**
     * オーナー照会リンクIDを設定します。
     * @param oLinkId オーナー照会リンクID
     */
    public void setOLinkId(String oLinkId) {
        this.oLinkId = oLinkId;
    }
