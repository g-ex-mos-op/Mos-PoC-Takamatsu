...
public class NotificationRegistDownloadTenpuLogicImpl implements DownloadLogic {

    /* ロジックID */
    public static final String LOGIC_ID = "BIF002L08";
    ...
    public String getFileName(final DownloadDto downloadDto) {
        ConditionDto dto = (ConditionDto) downloadDto;
        UITutatuInfo entity = (UITutatuInfo) dto.getListTutatu().get(dto.getDownloadIndex());
        String fileName = "";
