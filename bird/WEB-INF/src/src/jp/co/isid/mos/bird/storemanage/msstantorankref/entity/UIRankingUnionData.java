...
public class UIRankingUnionData {
    ...
    public static final String rankZennen_COLUMN = "RANK_ZENNEN";
    
    public static final String zenRankZennen_COLUMN = "ZEN_RANK_ZENNEN";
    
    public static final String hyoukaDataZennen_COLUMN = "HYOUKA_DATA_ZENNEN";
     ...
     * 前回ランキング
     */
    private BigDecimal rankZennen;
    
    /**
     * 前回全国順位
     */
    private BigDecimal zenRankZennen;
    
    /**
     * 前回総合ポイント
     */
    private BigDecimal hyoukaDataZennen;
     ...
     * @return 前回ランキング
     */
    public BigDecimal getRankZennen() {
        return rankZennen;
    }
    /**
     * 前回ランキングを設定します。
     * @param rankZennen 前回ランキング
     */
    public void setRankZennen(BigDecimal rankZennen) {
        this.rankZennen = rankZennen;
    }
     ...
     * @return 前回全国順位
     */
    public BigDecimal getZenRankZennen() {
        return zenRankZennen;
    }
    /**
     * 前回全国順位を設定します。
     * @param zenRankZennen 前回全国順位
     */
    public void setZenRankZennen(BigDecimal zenRankZennen) {
        this.zenRankZennen = zenRankZennen;
    }
     ...
     * @return 前回総合ポイント
     */
    public BigDecimal getHyoukaDataZennen() {
        return hyoukaDataZennen;
    }
    /**
     * 前回総合ポイントを設定します。
     * @param hyoukaDataZennen 前回総合ポイント
     */
    public void setHyoukaDataZennen(BigDecimal hyoukaDataZennen) {
        this.hyoukaDataZennen = hyoukaDataZennen;
    }
