...
public class NipoInfo {
    ...
    public static final String hanTenpoCntHosei_COLUMN    = "HAN_TENPO_CNT_HOSEI";
    ...
    public static final String hoseiFlg_COLUMN = "HOSEI_FLG";

    /** 行タイプ */
    private int rowType = 0;
    /** 販売店舗数 */
    private int hanTenpoCnt;
    /** 販売店舗数(NET値) */
    private int hanTenpoCntHosei = 0;
    private int hoseiFlg = 0;
    ...
    public String getEigyoDt() {
        if (eigyoDt != null && eigyoDt.endsWith("99")) {
            return "";
        }
        return eigyoDt;
    }
     ...
     */
    public void setHanTenpoCnt(int hanTenpoCnt) {
        this.hanTenpoCnt = hanTenpoCnt;
    }
    ...
    /**
     * 前年同月営業日補正データか否かを取得します。
     * @return boolean
     */
    public boolean isHosei() {
        return (getHoseiFlg()==1);
    }
    /**
	...
	/**
	 * @return hanTenpoCntHosei を戻します。
	 */
	public int getHanTenpoCntHosei() {
		return hanTenpoCntHosei;
	}
	/**
	 * @param hanTenpoCntHosei 設定する hanTenpoCntHosei。
	 */
	public void setHanTenpoCntHosei(int hanTenpoCntHosei) {
		this.hanTenpoCntHosei = hanTenpoCntHosei;
	}
	/**
	 * @return hoseiFlg を戻します。
	 */
	public int getHoseiFlg() {
		return hoseiFlg;
	}
	/**
	 * @param hoseiFlg 設定する hoseiFlg。
	 */
	public void setHoseiFlg(int hoseiFlg) {
		this.hoseiFlg = hoseiFlg;
	}
