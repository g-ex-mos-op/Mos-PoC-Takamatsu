select BT22.ENTRY_CD
     ...
     , BM01.SIBU_CD
     , BM10.SIBU_NAME
     , SUB1.SIBU_CD   as SIBU_TORIKOMI_CD
     , SUB1.SIBU_NAME as SIBU_TORIKOMI_NAME
     ...
     , (case when BM12.SEX in '0' then 'íj' else (case when BM12.SEX in '1' then 'èó' else '' end) end) as SEX 
     , BM12.BIRTHDAY
     , BM12.JOB
