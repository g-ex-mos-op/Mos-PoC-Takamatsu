package jp.co.isid.mos.bird.bizsupport.moschickenrefconflist2.action.impl;
...
import jp.co.isid.mos.bird.bizsupport.moschickenrefconflist2.action.ConditionAction;
import jp.co.isid.mos.bird.bizsupport.moschickenrefconflist.dto.MosChickenRefConfListCondDto;
import jp.co.isid.mos.bird.bizsupport.moschickenrefconflist2.dao.CodMiseListDao;
...
import jp.co.isid.mos.bird.framework.action.impl.PdfOutputActionImpl;
...
public class ConditionActionImpl implements ConditionAction {
    ...
    private jp.co.isid.mos.bird.bizsupport.moschickenrefconflist2.dto.MosChickenRefConfListDto mosChickenRefConfListDto2;
    /* DTO【モスチキン条件予約】*/
    private MosChickenRefConfListCondDto mosChickenRefConfListCondDto;
    /* DTO【オーナー選択】*/
    private OwnerSearchDto ownerSearchDto;
    private PdfOutputActionImpl pdfMosChikenRefConfTypeAAction;
    private PdfOutputActionImpl pdfMosChikenRefConfTypeBAction;
    ...
    private CodMiseListDao mosChickenrefconflistCodMiseListDao2;
    private String type;
    ...
    public String execAll() {
        String miseCdFrom = getMosChickenRefConfListDto2().getMiseCdFrom();
        String miseCdTo   = getMosChickenRefConfListDto2().getMiseCdTo();
        if (isNull(miseCdFrom)) {
            miseCdFrom = "00000";
        }
        if (isNull(miseCdTo)) {
            miseCdTo = "99999";
        ...
        DateFormatter formatter = new DateFormatter();
        String reserveDt = String.valueOf(formatter.format(String.valueOf(getMosChickenRefConfListDto().getReserveDate()),DateFormatter.PATTERN_NORMAL,DateFormatter.DATE_TYPE_YMD));
        List listMise = getMosChickenrefconflistCodMiseListDao2().getMiseInfo(getMosChickenRefConfListDto().getCkanriNo(), reserveDt, miseCdFrom, miseCdTo);
        
        for (Iterator ite = listMise.iterator(); ite.hasNext();) {
            CodMiseList entity = (CodMiseList) ite.next();
            getMosChickenRefConfListDto().setMiseCd(entity.getMiseCd());
            getMosChickenRefConfListDto().setMiseNmKj(entity.getMiseNameKj());
            if ("A".equals(getType())) {
                getPdfMosChikenRefConfTypeAAction().savePDF();
            }
            else {
                getPdfMosChikenRefConfTypeBAction().savePDF();
            }
        }
    ...
    public PdfOutputActionImpl getPdfMosChikenRefConfTypeAAction() {
        return pdfMosChikenRefConfTypeAAction;
    }
    public void setPdfMosChikenRefConfTypeAAction(
            PdfOutputActionImpl pdfMosChikenRefConfTypeAAction) {
        this.pdfMosChikenRefConfTypeAAction = pdfMosChikenRefConfTypeAAction;
    }
    public PdfOutputActionImpl getPdfMosChikenRefConfTypeBAction() {
        return pdfMosChikenRefConfTypeBAction;
    }
    public void setPdfMosChikenRefConfTypeBAction(
            PdfOutputActionImpl pdfMosChikenRefConfTypeBAction) {
        this.pdfMosChikenRefConfTypeBAction = pdfMosChikenRefConfTypeBAction;
    }
    public CodMiseListDao getMosChickenrefconflistCodMiseListDao2() {
        return mosChickenrefconflistCodMiseListDao2;
    }
    public void setMosChickenrefconflistCodMiseListDao2(
            CodMiseListDao mosChickenrefconflistCodMiseListDao2) {
        this.mosChickenrefconflistCodMiseListDao2 = mosChickenrefconflistCodMiseListDao2;
    }
    public jp.co.isid.mos.bird.bizsupport.moschickenrefconflist2.dto.MosChickenRefConfListDto getMosChickenRefConfListDto2() {
        return mosChickenRefConfListDto2;
    }
    public void setMosChickenRefConfListDto2(
            jp.co.isid.mos.bird.bizsupport.moschickenrefconflist2.dto.MosChickenRefConfListDto mosChickenRefConfListDto2) {
        this.mosChickenRefConfListDto2 = mosChickenRefConfListDto2;
    }
