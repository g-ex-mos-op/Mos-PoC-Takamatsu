...
import jp.co.isid.mos.bird.common.dao.CodBlockDao;
...
public class GetHyojiTaishoLogicImpl implements GetHyojiTaishoLogic {
    /** ロジックID */
    public static final String LOGIC_ID = "BSM000L01";

    /** パラメーター名：会社コード */
    public static final String PM_COMPANY_CD = "companyCd";
    /** パラメーターキー：対象条件 */
    public static final String PM_TAISHOJOKEN = "taishoJoken";
    /** パラメーターキー：アプリ日付 */
    ...
    private void validate(Map map) throws ApplicationException {
        ...
        if(UserType.ONER.equals(userTypeCd) && 
    ...
    private List executeList(final Map map) throws ApplicationException {
        ...
        else if (TaishoJoken.CODE_SEGMENT.equals(taishoJoken)) {
        	list = getCodHyojiTaishoDao().selectSegment(companyCd);
        }
        return list;
    }
    /**
