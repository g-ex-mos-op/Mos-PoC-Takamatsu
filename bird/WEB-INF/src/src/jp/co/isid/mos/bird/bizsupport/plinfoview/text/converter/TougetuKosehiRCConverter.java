 ...
 * @author xytamura
 */
public class TougetuKosehiRCConverter extends NormalConverter implements Converter, Formatter {

	private PlInfoViewDto plInfoViewDto;
    /**
     * コンストラクタ デフォルトのパターン
     */
    public TougetuKosehiRCConverter() {
        super();
    }
    ...
    public String getAsString(FacesContext facesContext,
        ...
        if (val != null && !val.trim().equals("")) {
            ...
            BigDecimal kingakuKei = getPlInfoViewDto().getBigKouseihiMoto();
