...
public interface UIEntryMstDao {
    ...
    /**
     * 全国店長勉強会マスタ情報リスト取得時のパラメータ
     */
    public static final String selectManage_ARGS = "entryCd, entryYear";
     ...
     * @return List 全国店長勉強会マスタ情報リスト
     */
    public List selectManage(String entryCd, String entryYear);
    ...
    /**
     * 全国店長勉強会マスタ情報を更新する。【主キー変更】
     * @param entity    エントリーマスタ管理エンティティ
     * @param entryYear エントリー年
     * @param entryKai  エントリー回
     * @return int 更新結果
     */
    public int updatePKey(UIEntryMst entity, String entryYear, String entryKai);
