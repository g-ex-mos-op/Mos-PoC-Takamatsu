...
public class NumericConverter extends NormalConverter implements Converter, Formatter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent uiComponent, String value)
        ...
        if (obj != null && !obj.toString().equals("")) {
            obj = jp.co.isid.mos.bird.framework.util.Converter.decToString(new BigDecimal(obj.toString()), this.digitsNum);
        }
    ...
    public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object value)
        ...
        if (value != null && !value.toString().equals("")) {
            value = jp.co.isid.mos.bird.framework.util.Converter.decToString(new BigDecimal(value.toString()), this.digitsNum);
        }
        else {
        	value = "0";
        }
