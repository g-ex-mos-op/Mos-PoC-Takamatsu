 ...
 * @author narita
 */
public class LongserviceRegistCommon {
    ...
    public static String setEmpty(String str) {
        return (str == null || str.trim().length() == 0) ?
        		LongserviceRegistConstants.EMPTY : str.trim();
    }
    ...
    public static BigDecimal setBicEmpty(BigDecimal num) {
        return num == null ? new BigDecimal(LongserviceRegistConstants.ZERO) : num;
    }
    ...
    public static String getConverNum(String str, int size) {
        while (str.length() < size) {
            str = LongserviceRegistConstants.ZERO + str;
        }
        return str;
    }
