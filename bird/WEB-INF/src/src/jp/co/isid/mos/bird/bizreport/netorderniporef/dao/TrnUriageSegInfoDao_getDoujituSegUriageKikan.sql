    ...
    (select
     ...
     from
        ...
        join (select
                 ...
                 max(bd54.open_kbn_zen_dojitu) as open_kbn_zen,
                 ...
                 sum(bd54.uriage) as uriage,
                 sum(bd54.kyakusu) as kyakusu,
                 sum(bd54.uriage_zen_dojitu) as uriage_zen,
                 sum(bd54.kyakusu_zen_dojitu) as kyakusu_zen,
                 sum(bd54.uriage_nsum) as uriage_nsum,
                 sum(bd54.kyakusu_nsum) as kyakusu_nsum,
                 sum(bd54.uriage_zen_dojitu_nsum) as uriage_nsum_zen,
                 sum(bd54.kyakusu_zen_dojitu_nsum) as kyakusu_nsum_zen,
                 sum(bd54.uriage_ntake) as uriage_ntake,
                 sum(bd54.kyakusu_ntake) as kyakusu_ntake,
                 sum(bd54.uriage_zen_dojitu_ntake) as uriage_ntake_zen,
                 sum(bd54.kyakusu_zen_dojitu_ntake) as kyakusu_ntake_zen,
                 sum(bd54.uriage_ntaku) as uriage_ntaku,
                 sum(bd54.kyakusu_ntaku) as kyakusu_ntaku,
                 sum(bd54.uriage_zen_dojitu_ntaku) as uriage_ntaku_zen,
                 sum(bd54.kyakusu_zen_dojitu_ntaku) as kyakusu_ntaku_zen
             from
                 BD54NNIP as bd54
             ...
             /*IF tenShu.equals("ALL")*/
                 and (bd54.open_kbn = 1 or bd54.open_kbn_zen_dojitu = 1)
             -- ELSE
                 and bd54.open_kbn = 1
             /*END*/
                 and bd54.oldm_flg = '0'
