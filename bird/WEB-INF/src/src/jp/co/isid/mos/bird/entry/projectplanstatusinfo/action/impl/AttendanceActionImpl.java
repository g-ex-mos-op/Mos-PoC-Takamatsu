...
import jp.co.isid.mos.bird.entry.projectplanstatusinfo.action.AttendanceAction;
 ...
 *   
 */
public class AttendanceActionImpl implements AttendanceAction {
    
    /** アクションID：初期処理 */
    public static final String initialize_ACTION_ID = ProjectPlanStatusInfoUtil.SCREEN_ID+"A11";
    /** アクションID：SV検索処理 */
    public static final String callSvForm_ACTION_ID = ProjectPlanStatusInfoUtil.SCREEN_ID+"A12";
    /** アクションID：戻る処理 */
    public static final String back_ACTION_ID = ProjectPlanStatusInfoUtil.SCREEN_ID+"A13";
    /** アクションID：実行（検索）処理 */
    public static final String search_ACTION_ID = ProjectPlanStatusInfoUtil.SCREEN_ID+"A14";
    /** アクション【初期画面】*/
    ...
    public String callSvForm() {
        getProjectPlanStatusInfoDto().setSpKbn(getProjectPlanStatusInfoDto().getAttendKbnChoice());
        return getProjectPlanStatusInfoConditionAction().callingSvForm(ProjectPlanStatusInfoUtil.VIEW_ID_ATTENDANCE);
    }
    /**
     * 戻るボタン処理
     */
