...
import jp.co.isid.mos.bird.bizreport.groupeigyoniporef.action.GroupEigyoNipoRefConditionAction;
 ...
 */
public class GroupEigyoNipoRefConditionActionImpl extends CsvOutput2ActionImpl implements GroupEigyoNipoRefConditionAction {
    /** アクション【初期化処理】ID */
    public static final String initialize_ACTION_ID   = "BBR001A01";
    /** アクション【実行】ID */
    public static final String search_ACTION_ID   = "BBR001A02";
    /** アクション【SV検索ボタン】ID */
    public static final String callSvForm_ACTION_ID   = "BBR001A50";
    /** アクション【営業月報抽出CSVダウンロード】ID */
    public static final String downloadCsvGepo_ACTION_ID   = "BBR001A23";
    ...
    public String callSvForm()  {
        ...
        getNewSvSearchDto().setNavigationCase(NipoRefConstants.VIEW_ID_E_CONDITION);
