 ...
 * @author xytamura
 */
public class ContactRegistDownloadKanrenLogicImpl implements DownloadLogic {
    ...
    public String getFileName(final DownloadDto downloadDto) {
        ContactRegistDto dto = (ContactRegistDto) downloadDto;
        ...
        fileName += entity.getFileName().trim();
