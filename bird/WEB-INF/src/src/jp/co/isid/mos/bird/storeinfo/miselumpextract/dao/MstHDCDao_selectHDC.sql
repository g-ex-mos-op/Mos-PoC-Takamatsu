select
	rtrim(BM27.COMPANY_CD)   as COMPANY_CD,
	rtrim(BM27.MISE_CD)      as MISE_CD,
	...
	rtrim(BM27.HDC_DT)       as HDC_DT,
	rtrim(BM27.HDC_NAIYOU)   as HDC_NAIYOU
from
	BM27HDCR BM27,
...
where
	BM27.COMPANY_CD = BM01.COMPANY_CD
and BM27.MISE_CD    = BM01.MISE_CD
and BM27.COMPANY_CD = /*companyCd*/'00'
