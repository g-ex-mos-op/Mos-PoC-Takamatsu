select
        ...
        SUB1.RESERVE_HH,
        SUB1.RESERVE_MM,
		sum(SUB1.RESERVE_AMT) as RESERVE_AMT
	from
		BM40CMGP as BM40,
	...
	group by BM40.MENU_GROUP, BM41.SUM_GROUP, BM41.MENU_CD, BM40.MENU_GROUP_NM, BM38.MENU_NAME_KJ,SUB1.RESERVE_HH, SUB1.RESERVE_MM 	
    order by BM40.MENU_GROUP, BM41.SUM_GROUP, BM41.MENU_CD