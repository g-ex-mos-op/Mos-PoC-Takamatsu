...
public class UIOfficialPointReadHisInfo {

	public static final String TABLE = "BD63YPRI";

	public static final String tmsp_COLUMN ="TMSP";

	public static final String nendo_COLUMN ="NENDO";

	public static final String userId_COLUMN ="USER_ID";

	public static final String toriSakujoFlg_COLUMN ="TORI_SAKUJO_FLG";
     ...
     * 取込ﾀｲﾑｽﾀﾝﾌﾟ
     */
    private java.sql.Timestamp tmsp;
	...
	/**
	 * @return toriSakujoFlg
	 */
	public String getToriSakujoFlg() {
		return toriSakujoFlg;
	}

	/**
	 * @param toriSakujoFlg セットする toriSakujoFlg
	 */
	public void setToriSakujoFlg(String toriSakujoFlg) {
		this.toriSakujoFlg = toriSakujoFlg;
	}
	...
	/**
	 * @param pointShuName セットする pointShuName
	 */
