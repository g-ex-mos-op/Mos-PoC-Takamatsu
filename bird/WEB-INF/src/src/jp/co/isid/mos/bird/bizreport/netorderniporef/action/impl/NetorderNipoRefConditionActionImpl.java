...
import jp.co.isid.mos.bird.bizreport.netorderniporef.action.NetorderNipoRefConditionAction;
 ...
 * ネット注文日報初期画面
 */
public class NetorderNipoRefConditionActionImpl extends CsvOutput2ActionImpl implements NetorderNipoRefConditionAction {
    /** アクション【初期化処理】ID */
    public static final String initialize_ACTION_ID   = "BBR017A01";
    /** アクション【実行】ID */
    public static final String search_ACTION_ID   = "BBR017A02";
    /** アクション【SV検索ボタン】ID */
        ...
        /*２．SV選択画面から遷移してきた場合。2008/12/09追加 **************************/
        	...
        	try {
	            ...
	            if(getNewSvSearchDto().getReturnKind() == SvSearchDto.RETURNKIND_SELECT){
	                ...
	                //SV-SELECT-4.店舗別画面VIEW_IDをリターンします。(ネット注文日報店舗別画面へ遷移)
