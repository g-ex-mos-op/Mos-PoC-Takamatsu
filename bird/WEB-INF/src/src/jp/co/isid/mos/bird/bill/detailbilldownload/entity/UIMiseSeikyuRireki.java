...
public class UIMiseSeikyuRireki {
    ...
    public static final String seikyuDtId_COLUMN = "SEIKYU_DT";
     ...
     * 訂正売上合計
     */
    private BigDecimal uriTei;
    
    /**
     * 非課税対象商品額
     */
    private BigDecimal taxnKin;
    
    /**
     * 課税対象商品額
     */
    private BigDecimal taxyKin;
     ...
     * 手入力消費税
     */
    private BigDecimal handTax;
    
    /**
     * 税込商品額
     */
    private BigDecimal komiKin;
     ...
     * 広告宣伝費金額
     */
    private BigDecimal kousenKin;
    
    /**
     * ロイヤルティ金額
     */
    private BigDecimal royalKin;
    
    /**
     * 売掛残高合計
     */
    private BigDecimal urizanAll;
     ...
     * @return 請求書ＩＤ
     */
    public String getSeikyuDtId() {
        return seikyuDtId;
    }
    /**
     * 請求書ＩＤを設定します。
     * @param seikyuDt 請求書ＩＤ
     */
    public void setSeikyuDtId(String seikyuDt) {
        this.seikyuDtId = seikyuDt;
    }
