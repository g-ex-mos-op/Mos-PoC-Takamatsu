...
import jp.co.isid.mos.bird.storemanage.mssonerpointref.dao.CodCompanyDao;
...
public class ConditionLogicImpl implements ConditionLogic {
    /** ロジックID定義 */
    public static final String LOGIC_ID = MssOnerPointRankRefAction.SCREEN_ID+"L01";
    /*【LOGIC】会社コード変更時ロジック */
    ...
    public Map execute(MssOnerPointRankCsvDto dto) throws Exception {
        ...
        getMssOnerPointRankChangeCompanyLogic().execute(dto);
     ...
     * @throws Exception
     */
    private void settingCompany(MssOnerPointRankCsvDto dto) throws Exception {
        //ユーザーID
        String userId = dto.getUserId();
        // Dao【会社情報】実行
        List list = getMssOnerPointRankCodCompanyDao().select(userId);
     ...
     */
    public CodCompanyDao getMssOnerPointRankCodCompanyDao() {
     ...
     */
    public void setMssOnerPointRankCodCompanyDao(CodCompanyDao dao) {
