...
public class TaishoJoken {
    ...
    /** コード値：本部 */
    public static final String CODE_HONBU         = "HONBU";
    /** コード値：事業本部 */
    ...
    public static List getPullDownList(String userTypeCd, String companyCd, boolean limitKbn) {
        ...
        if (UserType.HONBU.equals(userTypeCd)) {
            ...
            //モス・支部制限の時
                ...
                return CodeUtil.getPullDownList(CODE_TABLE_HONBU_LIMIT);
            }
            //モス以外
            else if (!CommonUtil.COMPANY_CD_MOS.equals(companyCd) && !limitKbn) {
            ...
            //モス以外・支部制限の時
                ...
                return CodeUtil.getPullDownList(CODE_TABLE_HONBU_NOTMOS_LIMIT); 
            }
        }
        //オーナーの時
        ...
        if (UserType.HONBU.equals(userTypeCd)) {
            ...
            if (companyCd != null && CommonUtil.COMPANY_CD_MOS.equals(companyCd)) {
                if (!limitKbn) {
                    ...
                    //モス・支部制限の時
                    return CodeUtil.getPullDownList(CODE_TABLE_HONBU_LIMIT, codes);
                }
            ...
            //モス以外・支部制限の時
                ...
                return CodeUtil.getPullDownList(CODE_TABLE_HONBU_NOTMOS_LIMIT, codes); 
            }
        }
        //オーナーの時
        else if(UserType.ONER.equals(userTypeCd)) {
