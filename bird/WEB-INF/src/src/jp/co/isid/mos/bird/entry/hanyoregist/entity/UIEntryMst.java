package jp.co.isid.mos.bird.entry.hanyoregist.entity;
...
public class UIEntryMst {
     ...
     * 受付開始
     */
    private String uketukeFrom;
    
    /**
     * 申込締切
     */
    private String uketukeTo;
     ...
     * @return 受付開始
     */
    public String getUketukeFrom() {
        return uketukeFrom;
    }
    /**
     * 受付開始を設定します。
     * @param uketukeFrom 受付開始
     */
    public void setUketukeFrom(String uketukeFrom) {
        this.uketukeFrom = uketukeFrom;
    }
     ...
     * @return 申込締切
     */
    public String getUketukeTo() {
        return uketukeTo;
    }
    /**
     * 申込締切を設定します。
     * @param uketukeTo 申込締切
     */
    public void setUketukeTo(String uketukeTo) {
        this.uketukeTo = uketukeTo;
    }
