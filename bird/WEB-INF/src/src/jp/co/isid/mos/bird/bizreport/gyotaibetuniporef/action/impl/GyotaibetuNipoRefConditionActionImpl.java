...
import jp.co.isid.mos.bird.bizreport.gyotaibetuniporef.action.GyotaibetuNipoRefConditionAction;
...
/**
 * 
 * @modifier xkinu 2013/01/20 海外売上集信対応
 * @modifier xkinu 2013/01/20 MOSCARD画面追加対応
 *
 */
public class GyotaibetuNipoRefConditionActionImpl implements
	GyotaibetuNipoRefConditionAction {
    /** 初期処理アクションID */
    public static final String initialize_ACTION_ID   = ACTION_ID+"01"; 
    /** 実行アクションID */ 
    public static final String enforcement_ACTION_ID  = ACTION_ID+"02"; 
    /** アクション【SV検索ボタン】処理ID */ 
    public static final String callSvForm_ACTION_ID  = ACTION_ID+"03"; 
        ...
        /*２．SV選択画面から遷移してきた場合。2008/12/09追加 **************************/
        	...
        	try {
	            ...
	            if(getNewSvSearchDto().getReturnKind() == SvSearchDto.RETURNKIND_SELECT){
	                ...
	                return GyotaibetuNipoConstants.yago_tenpo_ID;
	            }
        	}
    ...
    public String enforcement() {
        ...
        else if (UserType.isOner(getNipoRefConditionDto().getUserTypeCd()) ) {    
    ...
    public String callSvForm()  {
        ...
        getNewSvSearchDto().setNavigationCase(NipoRefConstants.VIEW_ID_Y_CONDITION);
