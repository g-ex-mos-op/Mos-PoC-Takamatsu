...
from 
(
select row_number() over(order by bm02.SORT_KEY, bm17.SORT_KEY, rtrim(bt03.sort_seq), rtrim(bt03.reg_date) desc, rtrim(bt03.seq) desc) as row_num,
...
from
   ...
   left outer join bc08cbmn bc08 on bc08.bumon_cd = bt03.pub_org,
   bm02ifct bm02,
   bm17sbct bm17
