 ...
 * @author xytamura
 */
public class TougetuKosehiConverter extends NormalConverter implements Converter, Formatter {

	private PlInfoViewDto plInfoViewDto;
    /**
     * コンストラクタ デフォルトのパターン
     */
    public TougetuKosehiConverter() {
        super();
    }
    ...
    public String getAsString(FacesContext facesContext,
        ...
        if (val != null && !val.trim().equals("") && getPlInfoViewDto().getEntityTougetu() != null) {
        	BigDecimal kingaku = new BigDecimal(val);
            BigDecimal kingakuKei = getPlInfoViewDto().getEntityTougetu().getUriagedaka();
