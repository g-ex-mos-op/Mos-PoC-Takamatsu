SELECT
    ...
    br17entl.last_pgm,
    br17entl.last_tmsp,
    br18odate.from_dt AS OPEN_FROM,
    br18odate.to_dt AS OPEN_TO,
...
FROM
    br17entl
JOIN br18entd AS br18odate ON (br17entl.entry_cd = br18odate.entry_cd
	AND br17entl.entry_year = br18odate.entry_year AND br17entl.entry_kai = br18odate.entry_kai AND br18odate.usertype_cd = '99' AND br18odate.day_kbn = '01')
