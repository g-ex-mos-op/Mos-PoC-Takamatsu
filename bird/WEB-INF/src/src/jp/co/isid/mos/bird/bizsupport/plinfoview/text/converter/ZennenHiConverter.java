 ...
 * @author xytamura
 */
public class ZennenHiConverter extends NormalConverter implements Converter, Formatter {

	private PlInfoViewDto plInfoViewDto;
    /**
     * コンストラクタ デフォルトのパターン
     */
    public ZennenHiConverter() {
        super();
    }
    ...
    public String getAsString(FacesContext facesContext,
        ...
        if (!(tounen == null || tounen.trim().equals("")
                || zennen == null || zennen.trim().equals("")))
        {
            BigDecimal kinTou = new BigDecimal(tounen);
            BigDecimal kinZen = new BigDecimal(zennen);
            kosehi = Calculator.percentage(kinTou, kinZen, 2);
        }
