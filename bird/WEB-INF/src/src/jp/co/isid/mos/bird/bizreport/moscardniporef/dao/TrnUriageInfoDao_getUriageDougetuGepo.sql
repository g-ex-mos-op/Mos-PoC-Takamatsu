...
/*END*/
       ...
       ,     (select bd36.company_cd
			  ...
			  LEFT JOIN (
				     SELECT MAX3.EIGYO_DT, MAX3.COMPANY_CD, MAX3.MISE_CD
				    ...
				    GROUP BY MAX3.EIGYO_DT, MAX3.COMPANY_CD, MAX3.MISE_CD
