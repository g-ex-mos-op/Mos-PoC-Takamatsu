...
public class MstMiSeRiRekiJoho {
	private String miseMDate; // 店Ｍ有効日
	private String miseCd; // 店コード
	private String miseNameKj; // 店名称（漢字）
	private String miseNameKna; // 店名称（カナ）
	private String onerCd; // オーナーコード
	private String onerNameKj; // オーナー名称
	private String sibuCd; // 支部コード
	private String sibuName; // 支部名称
	private String sibuToriCd; // 支部取込コード
	private String sibuToriName; // 支部取込コード名称
	private String miseKbn; // 店区分
	private String aiteName; // 店区分名称
	private String gyotaiKbn; // 業態区分
	private String gyotaiKbnName; // 業態区分名称
	private String svCd; // 担当SVコード
	private String userNameKj; // 担当SV名称
	private String openDt; // 店オープン日
	private String closeDt; // 店クローズ日
	private String miseCdSaishin; // 新店時店コード
	private String miseCdShinten; // 最新店コード
	private String kenCd; // 県コード
	private String kenName; // 県名称
	private String misePostNo; // 郵便番号
	private String miseAdrs1; // 店住所1
	private String miseAdrs2; // 店住所2
	private String miseAdrs3; // 店住所3
	private String miseTel; // 電話番号
	private String mTypeKbn; // 店舗タイプ区分
	private String mTypeKbnName; // 店舗タイプ区分名称
	private String tMiseKeitai; // 店舗形態区分
	private String mKeitaiName; // 店舗形態区分名称
	private String tLocateKbn; // ロケーション区分
	private String locateName; // ロケーション区分名称
	private String tentai; // 転貸
	private String tentaiStartDt; // 転貸開始日
	private String tentaiEndDt; // 転貸終了日
	private String tentaiInfo; // 転貸情報
	private String miseLeaseKCd; // 賃貸店舗経理コード
