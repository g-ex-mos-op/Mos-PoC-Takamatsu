...
public class MstCategoryInfo implements CategoryRegistEntity {
    ...
    public static final String newCateName_COLUMN = "CATE_NAME";
    
    public static final String oldCateName_COLUMN = "OLD_CATE_NAME";
