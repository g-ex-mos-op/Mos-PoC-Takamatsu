...
(
    select 
      bd03.company_cd,
      bd03.mise_cd,
      sum(bd03.uriage) as hanbai_kin,
      sum(bd03.kazu_kei * (case when menuMst.conv_value is null then 1 else menuMst.conv_value end)) as hanbai_kosu
    from 
      bd03cpml bd03,
      bm60cpdt bm60,
      bm65cpms bm65,
    ...
    and bd03.menu_dt = /*kikanFrom*/'20080602'
