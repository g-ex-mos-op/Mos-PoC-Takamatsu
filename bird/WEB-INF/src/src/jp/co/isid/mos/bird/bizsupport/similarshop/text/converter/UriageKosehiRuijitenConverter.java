 ...
 * @author xtoshi
 */
public class UriageKosehiRuijitenConverter extends NormalConverter implements Converter, Formatter {

	private RuijitenReferenceDto ruijitenReferenceDto;
    /**
     * コンストラクタ デフォルトのパターン
     */
    public UriageKosehiRuijitenConverter() {
        super();
    }
    ...
    public String getAsString(FacesContext facesContext,
        ...
        if (val != null && !val.trim().equals("")) {
            ...
            BigDecimal kingakuKei = getRuijitenReferenceDto().getMiseRuijiPLData().getUriagedaka();
