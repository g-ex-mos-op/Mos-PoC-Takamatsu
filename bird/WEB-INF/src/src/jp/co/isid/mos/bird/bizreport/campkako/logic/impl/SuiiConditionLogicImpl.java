 ...
 *
 */
public class SuiiConditionLogicImpl implements SuiiConditionLogic {
    /** ロジックID */    
    public static final String LOGIC_ID = "BBR014L12";
    ...
    private SuiiChangeCampLogic campKakoSuiiChangeCampLogic;
    ...
    public void execute(RequestSuiiDto requestDto) {
        ...
        getCampKakoSuiiChangeCampLogic().execute(requestDto);
        // ４．ブロック情報設定
    ...
    public SuiiChangeCampLogic getCampKakoSuiiChangeCampLogic() {
        return campKakoSuiiChangeCampLogic;
    }

    public void setCampKakoSuiiChangeCampLogic(
            SuiiChangeCampLogic campsuiirefChangeCampLogic) {
        this.campKakoSuiiChangeCampLogic = campsuiirefChangeCampLogic;
    }
