package jp.co.isid.mos.bird.entry.mlregist.entity;

import java.math.BigDecimal;
import java.sql.Timestamp;

public class UIEntryMaster {
    ...
    public static final String displayFromDt_COLUMN = "DISPLAY_FROM_DT";
    
    public static final String displayToDt_COLUMN = "DISPLAY_TO_DT";
     ...
     * 表示開始日(オーナー)
     */
    private String displayFromDt;
    
    /**
     * 表示終了日(オーナー)
     */
    private String displayToDt;
     ...
     * @return 表示開始日(オーナー)
     */
    public String getDisplayFromDt() {
        return displayFromDt;
    }
    /**
     * 表示開始日(オーナー)を設定します。
     * @param displayFromDt 表示開始日(オーナー)
     */
    public void setDisplayFromDt(String displayFromDt) {
        this.displayFromDt = displayFromDt;
    }
     ...
     * @return 表示終了日(オーナー)
     */
    public String getDisplayToDt() {
        return displayToDt;
    }
    /**
     * 表示終了日(オーナー)を設定します。
     * @param displayToDt 表示終了日(オーナー)
     */
    public void setDisplayToDt(String displayToDt) {
        this.displayToDt = displayToDt;
    }
