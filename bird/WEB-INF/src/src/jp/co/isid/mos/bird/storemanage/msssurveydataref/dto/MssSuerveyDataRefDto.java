 ...
 * @author lee
 */
public class MssSuerveyDataRefDto {
    ...
    public boolean isReReadFlg() {
        return reReadFlg;
    }
    public void setReReadFlg(boolean reReadFlg) {
        this.reReadFlg = reReadFlg;
    }
