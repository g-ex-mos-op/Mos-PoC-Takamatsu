 ...
 *
 */
package jp.co.isid.mos.bird.analysis.sibuaverage.text;
...
public class NumericConverter extends NormalConverter implements Converter, Formatter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object value)
            throws ConverterException {
        String val = jp.co.isid.mos.bird.framework.util.Converter.decToString(new BigDecimal(super.getAsString(facesContext, uiComponent, value)), digitsNum, BigDecimal.ROUND_HALF_UP);
        String strFormat = numericFormatter.format(val, true);
