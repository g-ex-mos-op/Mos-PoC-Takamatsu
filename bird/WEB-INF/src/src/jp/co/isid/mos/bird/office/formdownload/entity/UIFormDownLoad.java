package jp.co.isid.mos.bird.office.formdownload.entity;
 ...
 * @author xytamura
 */
public class UIFormDownLoad implements TrnInfoAccessControl {
    
    public static final String TABLE = "BT04FRMM";
    ...
    public List getListDownloadFile() {
        ...
        for(int i = 0; i < listKenrenFile.size(); i++){
