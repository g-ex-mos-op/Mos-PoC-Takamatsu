...
public class UIBumonFilter {
    
    public static final String TABLE = "IR02BFLT";
    
    public static final String bumonCdFrom_COLUMN = "BUMON_CD_FROM";
    
    public static final String bumonCdTo_COLUMN = "BUMON_CD_TO";
    
    public static final String tekiyouDt_COLUMN = "TEKIYOU_DT";
    
    public static final String groupCd001Rflg_COLUMN = "GROUP_CD_001_RFLG";
    
    public static final String groupCd002Rflg_COLUMN = "GROUP_CD_002_RFLG";
    
    public static final String groupCd003Rflg_COLUMN = "GROUP_CD_003_RFLG";
    
    public static final String groupCd004Rflg_COLUMN = "GROUP_CD_004_RFLG";
    
    public static final String groupCd005Rflg_COLUMN = "GROUP_CD_005_RFLG";
    
    public static final String groupCd006Rflg_COLUMN = "GROUP_CD_006_RFLG";
    
    public static final String groupCd007Rflg_COLUMN = "GROUP_CD_007_RFLG";
    
    public static final String groupCd008Rflg_COLUMN = "GROUP_CD_008_RFLG";
    
    public static final String groupCd009Rflg_COLUMN = "GROUP_CD_009_RFLG";
    
    public static final String groupCd010Rflg_COLUMN = "GROUP_CD_010_RFLG";
    
    public static final String groupCd011Rflg_COLUMN = "GROUP_CD_011_RFLG";
    
    public static final String groupCd012Rflg_COLUMN = "GROUP_CD_012_RFLG";
    
    public static final String groupCd013Rflg_COLUMN = "GROUP_CD_013_RFLG";
    
    public static final String groupCd014Rflg_COLUMN = "GROUP_CD_014_RFLG";
    
    public static final String groupCd015Rflg_COLUMN = "GROUP_CD_015_RFLG";
    
    public static final String groupCd016Rflg_COLUMN = "GROUP_CD_016_RFLG";
    
    public static final String groupCd017Rflg_COLUMN = "GROUP_CD_017_RFLG";
    
    public static final String groupCd018Rflg_COLUMN = "GROUP_CD_018_RFLG";
    
    public static final String groupCd019Rflg_COLUMN = "GROUP_CD_019_RFLG";
    
    public static final String groupCd020Rflg_COLUMN = "GROUP_CD_020_RFLG";
    
    public static final String groupCdRflg_COLUMN = "GROUP_RFLG";
    
    public static final String groupCd_COLUMN = "GROUP_CD";
    
    public static final String groupName_COLUMN = "GROUP_NAME";
    
    public static final String sortSeq_COLUMN = "SORT_SEQ";
    
    public static final String renkeiFLG__COLUMN = "RENKEI_FLG";
