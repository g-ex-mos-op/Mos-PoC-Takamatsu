 ...
 * @author xytamura
 */
public class ZennenKosehiConverter extends NormalConverter implements Converter, Formatter {

	private PlInfoViewDto plInfoViewDto;
    /**
     * コンストラクタ デフォルトのパターン
     */
    public ZennenKosehiConverter() {
        super();
    }
    ...
    public String getAsString(FacesContext facesContext,
        ...
        if (val != null && !val.trim().equals("") && getPlInfoViewDto().getEntityZennen() != null) {
            BigDecimal kingaku = new BigDecimal(val);
            BigDecimal kingakuKei = getPlInfoViewDto().getEntityZennen().getUriagedaka();
