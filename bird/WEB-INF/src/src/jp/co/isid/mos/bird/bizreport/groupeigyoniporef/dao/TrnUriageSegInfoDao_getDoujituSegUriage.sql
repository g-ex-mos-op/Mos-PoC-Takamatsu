...
from
    ...
    (select
        ...
        sum(bt60.open_kbn_zen_dojitu) as open_kbn_zen,
     ...
     from
        ...
        join bt60znip as bt60 on (bt60.company_cd = bm01.company_cd and bt60.mise_cd = bm01.mise_cd)
    ...
    and bt60.eigyo_dt = /*kikanFrom*/'20060501'
/*IF tenShu.equals("ALL")*/
    and (bt60.open_kbn = 1 or bt60.open_kbn_zen_dojitu = 1)
-- ELSE
    and bt60.open_kbn = 1
/*END*/
    and bt60.oldm_flg = '0'
