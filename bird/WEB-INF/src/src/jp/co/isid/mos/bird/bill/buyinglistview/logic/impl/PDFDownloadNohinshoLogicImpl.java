...
public class PDFDownloadNohinshoLogicImpl implements PDFDownloadNohinshoLogic {
    
    /** ロジックID 定義 */
    public static final String LOGIC_ID = "BBS012L06";
    ...
    public String getFileFullPath(final DownloadDto downloadDto) {
        String path = BirdContext.getProperty("fileProperty", "filePathSeikyuNohinsho");
