...
public class UIBasicListDataInfo {
    ...
    public static final String basicDtFrom_COLUMN = "BASIC_DT_FROM";
    
    public static final String basicDtTo_COLUMN = "BASIC_DT_TO";
     ...
     * @param basicDtFrom ベーシック研修開催日FROM
     */
