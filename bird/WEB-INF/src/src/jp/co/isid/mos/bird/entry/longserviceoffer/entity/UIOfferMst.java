...
public class UIOfferMst {
    ...
    /** 
     * デフォルトの永年勤続マスタ情報：送付先名
     */
    private String defSoufuName;
    /** 
     * デフォルトの永年勤続マスタ情報：電話番号
     */
    private String defTel;
    /** 
     * デフォルトの永年勤続マスタ情報：職位
     */
    private String defJobType;
	...
	public String getDefJobType() {
		return defJobType;
	}
	public void setDefJobType(String defJobType) {
		this.defJobType = defJobType;
	}
	...
	public String getDefSoufuName() {
		return defSoufuName;
	}
	public void setDefSoufuName(String defSoufuName) {
		this.defSoufuName = defSoufuName;
	}
	public String getDefTel() {
		return defTel;
	}
	public void setDefTel(String defTel) {
		this.defTel = defTel;
	}    
}
