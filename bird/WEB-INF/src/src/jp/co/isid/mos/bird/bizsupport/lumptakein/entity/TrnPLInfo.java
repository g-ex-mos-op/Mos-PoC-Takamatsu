...
public class TrnPLInfo {
    ...
    public static final String lastDt_COLUMN = "LAST_DT";
     ...
     * エラー情報
     */
    private PlDataErrorInfo plDataErrorInfo = new PlDataErrorInfo();
    ...
    public void fillBlankItem() {
        fillBlankItem(BigDecimal.valueOf(0));
    }
     ...
     * @param value 設定値
     */
    public void fillBlankItem(BigDecimal value) {
        setUriagedaka((getUriagedaka() == null) ? value : getUriagedaka());
        setUriagegenka((getUriagegenka() == null) ? value : getUriagegenka());
        setUriageSoRieki((getUriageSoRieki() == null) ? value : getUriageSoRieki());
        setSalary((getSalary() == null) ? value : getSalary());
        setYachin((getYachin() == null) ? value : getYachin());
        setSuikouHi((getSuikouHi() == null) ? value : getSuikouHi());
        setRoyalty((getRoyalty() == null) ? value : getRoyalty());
        setTesuryo((getTesuryo() == null) ? value : getTesuryo());
        setKoukoku((getKoukoku() == null) ? value : getKoukoku());
        setShoumou((getShoumou() == null) ? value : getShoumou());
        setHouteiFukuri((getHouteiFukuri() == null) ? value : getHouteiFukuri());
        setFukuriKousei((getFukuriKousei() == null) ? value : getFukuriKousei());
        setKousai((getKousai() == null) ? value : getKousai());
        setRyohi((getRyohi() == null) ? value : getRyohi());
        setTusin((getTusin() == null) ? value : getTusin());
        setLease((getLease() == null) ? value : getLease());
        setSharyo((getSharyo() == null) ? value : getSharyo());
        setSozei((getSozei() == null) ? value : getSozei());
        setHoken((getHoken() == null) ? value : getHoken());
        setUnchin((getUnchin() == null) ? value : getUnchin());
        setShuzen((getShuzen() == null) ? value : getShuzen());
        setYobi((getYobi() == null) ? value : getYobi());
        setZappi((getZappi() == null) ? value : getZappi());
        setKeihiShokei((getKeihiShokei() == null) ? value : getKeihiShokei());
        setShokyakuRieki((getShokyakuRieki() == null) ? value : getShokyakuRieki());
        setGenkaShokyaku((getGenkaShokyaku() == null) ? value : getGenkaShokyaku());
        setEigaiShueki((getEigaiShueki() == null) ? value : getEigaiShueki());
        setEigaiHiyo((getEigaiHiyo() == null) ? value : getEigaiHiyo());
        setHonshahiHai((getHonshahiHai() == null) ? value : getHonshahiHai());
        setRieki((getRieki() == null) ? value : getRieki());
        setUriage((getUriage() == null) ? value : getUriage());
        setBuppan((getBuppan() == null) ? value : getBuppan());
        setUriUchiwake((getUriUchiwake() == null) ? value : getUriUchiwake());
        setElec((getElec() == null) ? value : getElec());
        setGas((getGas() == null) ? value : getGas());
        setWater((getWater() == null) ? value : getWater());
        setSonota((getSonota() == null) ? value : getSonota());
        setSuikouUchiwake((getSuikouUchiwake() == null) ? value : getSuikouUchiwake());
        setGenzairyoKei((getGenzairyoKei() == null) ? value : getGenzairyoKei());
        setGenzairyoShire((getGenzairyoShire() == null) ? value : getGenzairyoShire());
        setGenzairyoZaiko((getGenzairyoZaiko() == null) ? value : getGenzairyoZaiko());
        setYasaiKei((getYasaiKei() == null) ? value : getYasaiKei());
        setYasaiShire((getYasaiShire() == null) ? value : getYasaiShire());
        setYasaiZaiko((getYasaiZaiko() == null) ? value : getYasaiZaiko());
        setHouzaiKei((getHouzaiKei() == null) ? value : getHouzaiKei());
        setHouzaiShire((getHouzaiShire() == null) ? value : getHouzaiShire());
        setHouzaiZaiko((getHouzaiZaiko() == null) ? value : getHouzaiZaiko());
        setBuppanKei((getBuppanKei() == null) ? value : getBuppanKei());
        setBuppanShire((getBuppanShire() == null) ? value : getBuppanShire());
        setBuppanZaiko((getBuppanZaiko() == null) ? value : getBuppanZaiko());
        setTouSiireKei((getTouSiireKei() == null) ? value : getTouSiireKei());
        setTouZaikoKei((getTouZaikoKei() == null) ? value : getTouZaikoKei());
        setSashihikiKei((getSashihikiKei() == null) ? value : getSashihikiKei());
        setYakuinSalary((getYakuinSalary() == null) ? value : getYakuinSalary());
        setYakuinBonus((getYakuinBonus() == null) ? value : getYakuinBonus());
        setYakuinRetire((getYakuinRetire() == null) ? value : getYakuinRetire());
        setYakuinKei((getYakuinKei() == null) ? value : getYakuinKei());
        setSalarySalary((getSalarySalary() == null) ? value : getSalarySalary());
        setSalaryBonus((getSalaryBonus() == null) ? value : getSalaryBonus());
        setSalaryRetire((getSalaryRetire() == null) ? value : getSalaryRetire());
        setSalaryKei((getSalaryKei() == null) ? value : getSalaryKei());
        setZakkyuSalary((getZakkyuSalary() == null) ? value : getZakkyuSalary());
        setZakkyuBonus((getZakkyuBonus() == null) ? value : getZakkyuBonus());
        setZakkyuRetire((getZakkyuRetire() == null) ? value : getZakkyuRetire());
        setZakkyuKei((getZakkyuKei() == null) ? value : getZakkyuKei());
        setKyuryoKei((getKyuryoKei() == null) ? value : getKyuryoKei());
        setBonusKei((getBonusKei() == null) ? value : getBonusKei());
        setRetireKei((getRetireKei() == null) ? value : getRetireKei());
        setSalaryUtiKei((getSalaryUtiKei() == null) ? value : getSalaryUtiKei());
        setKashiireUp((getKashiireUp() == null) ? value : getKashiireUp());
        setKashiireDown((getKashiireDown() == null) ? value : getKashiireDown());
        setKashiireZandaka((getKashiireZandaka() == null) ? value : getKashiireZandaka());
        setKappuUp((getKappuUp() == null) ? value : getKappuUp());
        setKappuDown((getKappuDown() == null) ? value : getKappuDown());
        setKappuZandaka((getKappuZandaka() == null) ? value : getKappuZandaka());
        setLeaseUp((getLeaseUp() == null) ? value : getLeaseUp());
        setLeaseDown((getLeaseDown() == null) ? value : getLeaseDown());
        setLeaseZandaka((getLeaseZandaka() == null) ? value : getLeaseZandaka());
        setTouZoukaKei((getTouZoukaKei() == null) ? value : getTouZoukaKei());
        setTouGenshoKei((getTouGenshoKei() == null) ? value : getTouGenshoKei());
        setTouZandakaKei((getTouZandakaKei() == null) ? value : getTouZandakaKei());
    }
}
