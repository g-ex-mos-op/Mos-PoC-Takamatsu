...
/*IF userTypeCd == "03" */
      ...
      ,      SUM(CASE WHEN SUBSTR(BM01.MISE_KBN, 2,1)='1' THEN ONER_YOSAN
                      ELSE (CASE WHEN BT4.YOSAN IS NOT NULL THEN BT4.YOSAN ELSE 0 END) END) AS YOSAN
/*END*/
...
/*END*/
      ,    BT60ZNIP BT60
/*IF userTypeCd == "03" */
      LEFT JOIN BT45DSJY BT4 ON (BT4.MISE_CD = BT60.MISE_CD AND BT4.YOSAN_DT = BT60.EIGYO_DT)
      ,    BM07UTEN BM07
/*END*/
...
/*END*/
/*IF userTypeCd == "03" */
      LEFT JOIN BT44MSJY BT4 ON (BT4.MISE_CD = BT64.MISE_CD AND YOSAN_DT = EIGYO_DT)
      ,    BM07UTEN BM07
/*END*/
      WHERE BM01.COMPANY_CD IN /*companyCdList*/('00')
