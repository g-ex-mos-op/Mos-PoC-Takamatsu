...
/*END*/
  ...
  from BR17ENTL BR17 
       join ( select ENTRY_CD
                   , ENTRY_YEAR
                   , ENTRY_KAI
                   , rtrim(FROM_DT)    as BASIC_DT_FROM
                   , rtrim(TO_DT)      as BASIC_DT_TO
                from BR18ENTD
       ...
       join ( select ENTRY_CD
                   , ENTRY_YEAR
                   , ENTRY_KAI
                   , rtrim(FROM_DT)    as HONBU_INPUT_DT_FROM
                   , rtrim(TO_DT)      as HONBU_INPUT_DT_TO
                from BR18ENTD
       ...
       join ( select ENTRY_CD
                   , ENTRY_YEAR
                   , ENTRY_KAI
                   , rtrim(FROM_DT)    as ONER_INPUT_DT_FROM
                   , rtrim(TO_DT)      as ONER_INPUT_DT_TO
                from BR18ENTD
       ...
       join ( select ENTRY_CD
                   , ENTRY_YEAR
                   , ENTRY_KAI
                   , rtrim(FROM_DT)    as HONBU_OUTPUT_DT_FROM
                   , rtrim(TO_DT)      as HONBU_OUTPUT_DT_TO
                from BR18ENTD
               where USERTYPE_CD = '01'
                 and DAY_KBN     = '03'
            ) HONBUOUTPUT
       ...
       join ( select ENTRY_CD
                   , ENTRY_YEAR
                   , ENTRY_KAI
                   , rtrim(FROM_DT)    as ONER_OUTPUT_DT_FROM
                   , rtrim(TO_DT)      as ONER_OUTPUT_DT_TO
                from BR18ENTD
               where USERTYPE_CD = '02'
                 and DAY_KBN     = '03'
            ) ONEROUTPUT
