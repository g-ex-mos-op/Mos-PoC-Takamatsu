package jp.co.isid.mos.bird.bizreport.campsuiiref.util;
...
public class CampSuiiUtil {
     ...
     * @param requestDto
     */
    public static void searchSuii(SearchLogic logic, SessionSuiiDto sessionDto, RequestSuiiDto requestDto) {
     ...
     * @param viewDto
     */
    public static void setViewSuii(SearchLogic logic, SessionSuiiDto sessionDto, RequestSuiiDto requestDto, RequestSuiiDto viewDto) {
