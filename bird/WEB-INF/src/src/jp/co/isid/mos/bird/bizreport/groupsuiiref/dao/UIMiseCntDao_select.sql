/*IF "MISE".equals(parameterDto.taishoJoken) */
SELECT CODE
,      MISE_CNT_ALL
,      MISE_CNT
...
/*END*/
            ...
            /*IF "01".equals(userTypeCd) && "ALL".equals(parameterDto.tenpoShubetu) */
	...
	/*IF isCsv && "GEPO".equals(parameterDto.focusTab) ==false */
	  WHERE SUB.DT = /*parameterDto.focusTab*/'201001'
	--ELSE
	  WHERE SUB.DT BETWEEN /*parameterDto.kikanSiteiFrom*/'201001' AND /*parameterDto.kikanSiteiTo*/'201012'
	  AND   SUB.DT <= /*appYm*/'201305'
	/*END*/
	/*IF "1".equals(parameterDto.tenpoShubetu) || "3".equals(parameterDto.tenpoShubetu) */
	  AND   SUB.TENPO_SHU = /*parameterDto.tenpoShubetu*/'1'
	/*END*/
	/*IF "2".equals(parameterDto.tenpoShubetu) */
	  AND   SUB.TENPO_SHU IN ('1', '2')
	/*END*/
     AND   EXISTS (SELECT * FROM BM01TENM BM01
                WHERE BM01.COMPANY_CD = /*parameterDto.companyCd*/'00'
/*IF "MISE".equals(parameterDto.taishoJoken) */  
                AND   BM01.MISE_CD = /*parameterDto.hyojiTaisho*/'01776'
/*END*/
/*IF "02".equals(userTypeCd) && "ALL".equals(parameterDto.taishoJoken) */
                AND   BM01.ONER_CD = /*parameterDto.hyojiTaisho*/'37006'
/*END*/
/*IF "01".equals(userTypeCd) */
                AND   EXISTS (SELECT * FROM BM10GSIB BM10
                              WHERE  BM10.COMPANY_CD = BM01.COMPANY_CD 
	/*IF "JIGYOU".equals(parameterDto.taishoJoken) || "SLAREA".equals(parameterDto.taishoJoken) || "SIBU".equals(parameterDto.taishoJoken) */  
                              AND   BM10./*$parameterDto.taishoJoken*/'SIBU'_CD = /*parameterDto.hyojiTaisho*/'031'
		/*IF "SIBU".equals(parameterDto.taishoJoken) && parameterDto.existsBlockCd */
		                      AND   BM01.BLOCK_CD = /*parameterDto.blockCd*/'004'
		/*END*/
	/*END*/  
	...
	/*END*/
	/*IF "SEGMENT".equals(parameterDto.taishoJoken) */  
                AND   EXISTS (SELECT * FROM BM09GTSG BM09
                             WHERE SEGMENT_TYPE = /*parameterDto.hyojiTaisho*/'M' 
