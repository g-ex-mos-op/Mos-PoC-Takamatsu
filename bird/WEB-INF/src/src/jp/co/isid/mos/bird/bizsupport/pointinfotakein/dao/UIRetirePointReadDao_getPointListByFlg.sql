SELECT
	...
	COALESCE(SUM_POINT.POINTSUM,0) + COALESCE(BD59.POINT,0) AS POINT_RUIKEI,
	BD64.KB_COMPANY_CD,
	BD64.NYUSYA_DT,
	BD64.TAISHOKU_DT,
	BD64.KINZOKU_YEAR,
	...
	(COALESCE(SUM_POINT.POINTSUM,0)+COALESCE(BD59.POINT,0))*SUM_POINT.SIKYU_RATE AS T_SEISAN_POINT,
