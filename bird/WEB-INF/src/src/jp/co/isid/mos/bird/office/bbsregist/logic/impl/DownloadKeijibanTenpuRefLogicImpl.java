...
public class DownloadKeijibanTenpuRefLogicImpl implements DownloadLogic {
    ...
    public String getFileName(final DownloadDto downloadDto) {
        KeijibanRegistDto dto = (KeijibanRegistDto) downloadDto;
        UIKeijiban entity =  dto.getRefEntity();
