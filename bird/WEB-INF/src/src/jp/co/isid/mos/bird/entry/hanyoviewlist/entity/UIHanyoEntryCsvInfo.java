...
public class UIHanyoEntryCsvInfo {
...
//---20070117 マスタライセンスPh4対応---start---
    public static final String sibuTorikomiCd_COLUMN = "SIBU_TORIKOMI_CD";//支部取込コード
    
    public static final String sibuTorikomiName_COLUMN = "SIBU_TORIKOMI_NAME";//支部取込名称
