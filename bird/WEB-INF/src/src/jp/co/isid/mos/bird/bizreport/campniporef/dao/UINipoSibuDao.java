...
public interface UINipoSibuDao {
    ...
    public static final String select_ARGS = "targetTable, sysDate, userId, userTypeCd, limitFlg, companyCd, campId, menuTotaledKbn, tenpoShubetu, shukeiKbn, taishoKikan, taishoDtFrom, taishoDt, taishoJoken, hyojiTaisho, blockCd, zennenDataShubetu, taishoDtFromLastDay, targetZenneClm";
    public static final String selectDays_ARGS = "targetTable, sysDate, userId, userTypeCd, limitFlg, companyCd, campId, menuTotaledKbn, tenpoShubetu, shukeiKbn, taishoKikan, taishoDtFrom, taishoDt, taishoJoken, hyojiTaisho, blockCd, zennenDataShubetu, taishoDtFromLastDay, targetZenneClm";
    /**
     * 検索実行処理
     * 
     * @param targetTable
