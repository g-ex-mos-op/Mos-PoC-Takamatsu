...
,               (select bd54.company_cd
                 ...
                 ,		max(misecnt_kbn_nsum)    as misecnt_kbn_nsum
                 ,		max(misecnt_kbn_ntake)   as misecnt_kbn_ntake
                 ,		max(misecnt_kbn_ntaku)   as misecnt_kbn_ntaku
                 ,      sum(uriage)              as uriage
                 ,      sum(kyakusu)             as kyakusu
                 ,      sum(uriage_nsum)         as uriage_nsum
                 ,      sum(kyakusu_nsum)        as kyakusu_nsum
                 ...
                 and    bd54.open_kbn = 1
                 and    (bd54.uriage > 0 and bd54.uriage_zen_dogetu > 0)               
                 and    bn01.kbn1 = '1'
