...
,  (
    ...
    FROM (SELECT BT46.ENTRY_CD
          ...
          ,      BT46.COMPANY_CD
          ,      BT46.ONER_CD
          ,      MAX(CASE WHEN BT46.KYOEI_FLG = '0' THEN 1 ELSE 0 END) AS ATTEND
          ,      MAX(CASE WHEN BT46.KYOEI_FLG = '1' THEN 1 ELSE 0 END) AS ABSENT
...
, (
    ...
    ,      BT46.ENTRY_YEAR
    ,      BT46.ENTRY_KAI
    ,      SUM(CASE WHEN BT46.KYOEI_FLG = '0' THEN 1 ELSE 0 END) AS ATTEND
    ,      SUM(CASE WHEN BT46.KYOEI_FLG = '1' THEN 1 ELSE 0 END) AS ABSENT
    FROM (SELECT MISE.SIBU_CD
          ,      MISE.ONER_CD 
          ,      ONER.ONER_NAME_KJ
          ,      ONER.KEIYAKU_STA
