SELECT DISTINCT YOSAN_JITUMISE4
  ,    YOSAN_JITUMISE5
  ,    YOSAN_JITUMISE6
  ,    YOSAN_JITUMISE7
  ,    YOSAN_JITUMISE8
...
LEFT JOIN(SELECT SIBU_CD
              ,   SUM(YOSAN) AS YOSAN_JITUMISE4
             FROM BT42MSYD
            WHERE MISE_CD NOT LIKE 'X%'
