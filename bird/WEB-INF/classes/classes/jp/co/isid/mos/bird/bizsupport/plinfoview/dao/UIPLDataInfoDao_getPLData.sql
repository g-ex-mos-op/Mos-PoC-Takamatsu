...
and BM01TENM.COMPANY_CD = BM10GSIB.COMPANY_CD 
and BM01TENM.SIBU_CD = BM10GSIB.SIBU_CD 
and BT17PLDT.ERR_FLG = '0' 
/*IF tenpoShu == "1" */and BM01TENM.OPEN_DT < /*openDtCond1*/'20050401' /*END*/
/*IF tenpoShu == "2" */
and (BM01TENM.OPEN_DT < /*openDtCond1*/'20050401' or (BM01TENM.OPEN_DT >= /*openDtCond2*/'20050401' and BM01TENM.OPEN_DT < /*openDtCond3*/'20060401')) 
/*END*/
/*IF tenpoShu == "3" */and BM01TENM.OPEN_DT >= /*openDtCond1*/'20050401' /*END*/
/*IF taishoTenpo == "2"*/and BM10GSIB.JIGYOU_CD = /*code1*/'11000'/*END*/
/*IF taishoTenpo == "3"*/and BM10GSIB.SLAREA_CD = /*code1*/'11000'/*END*/
/*IF taishoTenpo == "4"*/and BM10GSIB.SIBU_CD = /*code1*/'031' /*IF code2 != null */and BM01TENM.BLOCK_CD = /*code2*/'001'/*END*//*END*/
/*IF taishoTenpo == "6"*/and BM01TENM.MISE_CD = /*code1*/'01776'/*END*/
/*IF taishoTenpo == "7"*/and BM01TENM.ONER_CD = /*code1*/'36478'/*END*/
/*IF isLimit == true */
