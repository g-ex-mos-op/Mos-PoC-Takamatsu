...
/*IF taishouListChoice == "0" && attendKbnChoice == "0"*/
AND   REGDATA.JIGYO_FLG = '0'
/*END*/

/*IF taishouListChoice == "0" && attendKbnChoice == "1"*/
AND   REGDATA.JIGYO_FLG = '1'
/*END*/

/*IF taishouListChoice == "1" && attendKbnChoice == "0"*/
AND   REGDATA.KONSHIN_FLG = '0'
/*END*/

/*IF taishouListChoice == "1" && attendKbnChoice == "1"*/
AND   REGDATA.KONSHIN_FLG = '1'
/*END*/

/*IF taishouListChoice == "2" && attendKbnChoice == "0"*/
AND   REGDATA.KYOEI_FLG = '0'
/*END*/

/*IF taishouListChoice == "2" && attendKbnChoice == "1"*/
AND   REGDATA.KYOEI_FLG = '1'
/*END*/
