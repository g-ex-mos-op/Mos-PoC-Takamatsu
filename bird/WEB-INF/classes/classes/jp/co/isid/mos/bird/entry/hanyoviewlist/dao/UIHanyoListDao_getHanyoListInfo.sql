select BR17.ENTRY_CD      
  ...
  from BR17ENTL BR17 
       ...
       left join ( select ENTRY_CD
              ...
              on ( ENUM.ENTRY_CD   = BR17.ENTRY_CD   and
                   ENUM.ENTRY_YEAR = BR17.ENTRY_YEAR and
                   ENUM.ENTRY_KAI  = BR17.ENTRY_KAI      ) 
...
/*IF entryCd.equals("ZZ")*/

 where (BR17.ENTRY_CD = '05' or BR17.ENTRY_CD = '30')

/*END*/

/*IF !entryCd.equals("ZZ")*/

 where BR17.ENTRY_CD = /*entryCd*/'05'
