...
,      (CASE WHEN BD11.MENU_BUNRUI IS NULL  THEN '‡Œv' 
			 WHEN BD11.MENU_BUNRUI IS NOT NULL AND BD11.SUM_MENU_CD IS NULL THEN CONCAT(RTRIM(BD11.MBUNRUI_NAME_KJ) ,'Œv')
...
/*IF taishoJoken.equals("MISE") */  
		...
		,      COUNT(DISTINCT CASE WHEN BD11.KAZU_KEI > 0 THEN BD11.MISE_CD ELSE null END) AS HANBAI_TENPO_CNT 
--ELSE		
		,      0 AS TENPO_CNT
...
/*END*/
		...
		AND   BD11.COMPANY_CD = BM01.COMPANY_CD 
