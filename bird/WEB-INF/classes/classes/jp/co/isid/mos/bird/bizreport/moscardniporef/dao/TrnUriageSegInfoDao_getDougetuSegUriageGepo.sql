...
LEFT JOIN (
     ...
     ,        DECIMAL(count(distinct bt44.mise_cd)) AS mise_count
     ...
     where    bt44.sibu_cd = sibu.sibu_cd
     AND      bt44.YOSAN <> 0
     /*IF taishoKikan.equals("KIBETU")*/
         and      bt44.yosan_dt   between /*kikanFrom*/'20060525' and /*kikanTo*/'20060531' 
     -- ELSE
         and      bt44.yosan_dt   = /*kikanFrom*/'20130109'
     /*END*/    
     /*IF !tenShu.equals("ALL")*/
   		 /*IF tenShu.equals("2")*/
	         and      (bt44.tenpo_shu = '1' or bt44.tenpo_shu = '2')
   		 -- ELSE
    		 and       bt44.tenpo_shu = /*tenShu*/'1 '
        /*END*/
     /*END*/
    /*IF limitFlg == true*/
  			  and             bt44.sibu_cd in (
