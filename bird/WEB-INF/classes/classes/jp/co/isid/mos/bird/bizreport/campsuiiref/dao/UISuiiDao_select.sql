...
,      SUM(CASE WHEN BN01.URIAGE_NET IS NULL THEN 0 ELSE BN01.URIAGE_NET END) AS NET_URIAGE
,      SUM(CASE WHEN BN01.KYAKUSU_NET IS NULL THEN 0 ELSE BN01.KYAKUSU_NET END)  AS NET_KYAKUSU
,      SUM(CASE WHEN BN01.URIAGE_ZEN_NET IS NULL THEN 0 ELSE BN01.URIAGE_ZEN_NET END)   AS NET_URIAGE_ZEN
,      SUM(CASE WHEN BN01.KYAKUSU_ZEN_NET IS NULL THEN 0 ELSE BN01.KYAKUSU_ZEN_NET END)  AS NET_KYAKUSU_ZEN
/*END*/
FROM 
( 
...
/*IF zenDataShubetu.equals("DOGETUHOSEI") */
         ...
         ,      (CASE WHEN BT60.OPEN_KBN =1 AND BT60.OPEN_KBN_ZEN_DOGETU = 1 AND BT60.URIAGE_ZEN_DOGETU > 0
                      THEN BT60.KYAKUSU ELSE 0 END) AS KYAKUSU_NET
