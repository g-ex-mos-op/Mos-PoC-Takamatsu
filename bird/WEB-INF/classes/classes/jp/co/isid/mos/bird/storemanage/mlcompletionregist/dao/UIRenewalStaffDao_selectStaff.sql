...
,   (CASE WHEN BT26.LICENSE_DT IS NULL THEN '' ELSE BT26.LICENSE_DT END) AS LICENSE_DT
,   (CASE WHEN BT26.LICENSE_UP_DT IS NULL THEN '' ELSE BT26.LICENSE_UP_DT END) AS LICENSE_UP_DT
,   (CASE WHEN BT26.LICENSE_VALID_DT IS NULL THEN '' ELSE BT26.LICENSE_VALID_DT END) AS LICENSE_VALID_DT
...
,   CASE WHEN BT26.STAFF_ID IS NULL THEN 'INSERT' ELSE 'UPDATE' END AS DATA_STATUS
...
LEFT JOIN (SELECT * 
           ...
           AND   ENTRY_YEAR = /*entryYear*/'9999'
           AND   ENTRY_KAI  = /*entryKai*/'001'
) BT22
     ON (BT22.STAFF_ID   = BM12.STAFF_ID)
LEFT JOIN (select LIST.STAFF_ID
           ...
           AND   LIST.ENTRY_YEAR = /*entryYear*/'9999'
           AND   LIST.ENTRY_KAI  = /*entryKai*/'001'
     ) BT30
     ON (BT30.STAFF_ID   = BM12.STAFF_ID) 
LEFT JOIN (select LIST.STAFF_ID
           ,      SUM(CASE WHEN (ENTRY_CD = /*entryCd*/'01' AND ENTRY_YEAR = /*entryYear*/'9999' AND ENTRY_KAI  = /*entryKai*/'001')
                           THEN 0
                           ELSE 1
                           END
                  ) SHURYO_CNT 
...
LEFT JOIN BT26UPJK BT26
     ON (BT26.STAFF_ID   = BM12.STAFF_ID) 
where
      BC10.ENTRY_TYPE='1'
AND   BC10.ENTRY_CD = /*entryCd*/'01'
AND   BR17.ENTRY_YEAR = /*entryYear*/'9999'
AND   BR17.ENTRY_KAI = /*entryKai*/'001'
/*IF sibuCd != null*/
    AND   BM01.AREA_DAI = /*sibuCd*/'000'
/*END*/
...
order by 
	CASE WHEN BT22.STAFF_ID IS NULL THEN '0' ELSE '1' END DESC
,   BC10.ENTRY_CD
,   BR17.ENTRY_YEAR
,   BR17.ENTRY_KAI
,   BM12.COMPANY_CD
