...
このドキュメントは「DN-030110-021.01 Dao設計書(ネット注文帳票)」に関する設計書です。データアクセスオブジェクト（DAO）の設計情報を含んでいます。

含まれるシート: 変更履歴, 設定＆実行, NetOrderReportDataDao
...
![図1](DN-030110-021.01 Dao設計書(ネット注文帳票)_assets/images/設定＆実行_img_1.png)
![図2](DN-030110-021.01 Dao設計書(ネット注文帳票)_assets/images/設定＆実行_img_2.png)
![図3](DN-030110-021.01 Dao設計書(ネット注文帳票)_assets/images/設定＆実行_img_3.png)

| [BIRD]Dao設計書 |  | 管理番号：DN-030110-021.01<br>分類　　　：Dao設計書 | 管理番号：DN-030110-021.01<br>分類　　　：Dao設計書 | 更新者：王増文<br>更新日：2018/09/06 | 更新者：王増文<br>更新日：2018/09/06 | 作成者：王増文<br>作成日：2018/09/06 | 作成者：王増文<br>作成日：2018/09/06 |
|------|------|------|------|------|------|------|------|
| エンティティ出力先 | C:\Temp |  |  |  |  |  |  |
| 作成対象シート |  |  |  |  |  |  |  |
| 変更履歴 |  |  |  |  |  |  |  |
...
![図1](DN-030110-021.01 Dao設計書(ネット注文帳票)_assets/images/NetOrderReportDataDao_img_1.png)
...
| プロパティ名 | 論理名 |  | Java型 | 列型 | 参照 | 対象テーブル | 説明 | 説明 | 説明 |
