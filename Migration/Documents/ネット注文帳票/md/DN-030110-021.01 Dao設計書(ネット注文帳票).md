...
FROM
    (
        ...
        WHERE
            ...
            AND A1.COMPANY_CD = BM01TENM.COMPANY_CD
            AND A1.MISE_CD = BM01TENM.MISE_CD
            ...
            AND A1.OLDM_FLG = '0'
            AND (A1.OPEN_KBN = 1 OR A1.OP_KBN_ZEN_DOGETU = 1)
        ...
        WHERE
            BM01TENM.COMPANY_CD = '00'
            AND A2.COMPANY_CD = BM01TENM.COMPANY_CD
            AND A2.MISE_CD = BM01TENM.MISE_CD
            ...
            AND A2.OLDM_FLG = '0'
            AND (A2.OPEN_KBN = 1 OR A2.OP_KBN_ZEN_DOGETU = 1)
    )
GROUP BY
    JIGYOU_CD,
    JIGYOU_NAME,
